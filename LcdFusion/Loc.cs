...
namespace LcdFusion
{
    ...
    internal static class Loc
    {
        ...
        private static readonly Dictionary<string, string> It = new Dictionary<string, string>
        {
            ...
            { "changelog.title", "Novita di LCD Fusion" }, { "changelog.version", "Versione {0}" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "changelog.title", "What's new in LCD Fusion" }, { "changelog.version", "Version {0}" },
        ...
        private static readonly Dictionary<string, string> De = new Dictionary<string, string>
        {
            ...
            { "changelog.title", "Neu in LCD Fusion" }, { "changelog.version", "Version {0}" },
